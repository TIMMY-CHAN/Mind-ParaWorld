#!/usr/bin/env python3
"""
evaluate_with_judge.py - Setting A: Oracle-Facts QA 评估（LLM-as-Judge）
...
class SettingAJudgeEngine:
    """Setting A 的 LLM-as-Judge 评估引擎"""
    ...
    async def judge_single_sample(self, sample: Dict[str, Any]) -> Dict[str, Any]:
        ...
        Args:
            sample: 包含question, ground_truth, prediction的字典
...
async def main():
    parser = argparse.ArgumentParser(description="Setting A: LLM-as-Judge 评估")
    ...
    print("=" * 80)
    print("  Setting A: Oracle-Facts QA - LLM-as-Judge 评估")
    print("=" * 80)
    print()

    # 创建Judge引擎
    engine = SettingAJudgeEngine(
        args.judge_model,
        args.judge_api_base,
        args.judge_api_key,
        args.max_concurrent,
