#!/bin/bash
# batch_quantitative_analysis_settingB_guidance.sh - Setting B Guidance Prompt 定量分析
...
SETTING_B_DIR="$PROJECT_ROOT/setting_b_results/guidance_prompt"
SCRIPT_PATH="$PROJECT_ROOT/analysis/tools/quantitative_analysis_settingB_C.py"
OUTPUT_DIR="$PROJECT_ROOT/analysis_results/quantitative_settingB_guidance"

# 创建输出目录
mkdir -p "$OUTPUT_DIR"

# 查找所有 evaluated_results.jsonl 文件
echo "🔍 扫描 Setting B (Guidance) 模型..."
echo ""
